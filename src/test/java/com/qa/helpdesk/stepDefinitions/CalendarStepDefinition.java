    ...
    public void verifyCurrentDate() {
        try {
            ...
            if (today.equals(date)) {
                ...
                GemTestReporter.addTestStep("Calendar current date", "Current date mismatched expected: " + today + " actual: " + date + "", STATUS.FAIL, DriverAction.takeSnapShot());
        } catch (Exception e) {
            GemTestReporter.addTestStep("Exception Occurred", "Exception: " + e, STATUS.FAIL);
            throw new RuntimeException(e);
        }
        ...
        try {
            ...
            if (DriverAction.isExist(FilterAndCalendarLocators.calendarCard)) {
                ...
                if (calDay.contains(day) && calMonth.contains(month) && calYear.contains(year)) {
                    ...
                    GemTestReporter.addTestStep("Date Visibility", "Selected date is not visible, Expected: " + date + "", STATUS.FAIL, DriverAction.takeSnapShot());


            } else
                GemTestReporter.addTestStep("Calendar Visibility", "Calendar not visible", STATUS.FAIL, DriverAction.takeSnapShot());
        } catch (Exception e) {
            GemTestReporter.addTestStep("Exception Occurred", "Exception: " + e, STATUS.FAIL);
            throw new RuntimeException(e);
        }
    ...
    public void verifyIfTicketsShownAreInSelectedDateRange(String start, String end) {
        try {
            ...
            if (flag == 1) {
                ...
                GemTestReporter.addTestStep("Date Range", "Tickets found within selected date range", STATUS.PASS, DriverAction.takeSnapShot());
    ...
    public void verifyIfTicketsAreShownForSelectedDateOnly(String date) {
        try {
            ...
            if (flag == 1) {
                ...
                GemTestReporter.addTestStep("Date Selection", "Tickets found within selected date", STATUS.PASS, DriverAction.takeSnapShot());
